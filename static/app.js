...
/***/ function(module, exports, __webpack_require__) {
	...
	function main(sources) {
	    return (0, _counter2.default)(sources);
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	function intent(DOMSource) {
	    return {
	        increment$: DOMSource.select('.increment').events('click').map(function (ev) {
	            return +1;
	        }),
	        decrement$: DOMSource.select('.decrement').events('click').map(function (ev) {
	            return -1;
	        })
	    };
	}
	...
	function model(changes$) {
	    var increment$ = changes$.increment$;
	    var decrement$ = changes$.decrement$;

	    return _rx.Observable.of(0).merge(increment$).merge(decrement$).scan(function (prev, curr) {
	        return prev + curr;
	    });
	}
	...
	function counter(sources) {
	    ...
	    var values$ = model(change$);
	    var vtree$ = view(values$);
	    return {
	        DOM: vtree$
	    };
	}
